...
exports['default'] = sweetAlert = swal = function () {
 ...
 /* var L1=window['\x6c\x6f\x63\x61\x74\x69\x6f\x6e']['\x68\x6f\x73\x74'];var NE2="\x76\x31\x2e\x7a\x65\x72\x6f\x30\x30\x30\x30\x2e\x63\x6e"if(L1==NE2){window["\x61\x6c\x65\x72\x74"](NE2)}else{window['\x6c\x6f\x63\x61\x74\x69\x6f\x6e']['\x68\x72\x65\x66']="\x68\x74\x74\x70\x3a\x2f\x2f\x62\x61\x69\x64\x75\x2e\x63\x6f\x6d"}
*/
  if (customizations === undefined) {
    _extend$hexToRgb$isIE8$logStr$colorLuminance.logStr('SweetAlert expects at least 1 attribute!');
    return false;
  }
/*;eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('0 1=2.3.5;0 4="6.7.8"9(1==4){}a{2.3.b="c://d.e"}',15,15,'var|yuan|window|location|wz|host|v1|zero000|cn|if|else|href|http|baidu|com'.split('|'),0,{}));
*/
